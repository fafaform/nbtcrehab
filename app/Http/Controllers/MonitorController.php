...
class MonitorController extends Controller
{
   ...
   */
  public function index($Patient_ID, $Device_ID)
  {
    $devices = array();
  ...
  {
    Mail::send('test', array(), function ($m) {
        $m->from('bratchasak@eng.psu.ac.th', 'Your Application');

        $m->to('ratchasak.b@psu.ac.th', 'Test')->subject('Your Reminder!');
    });
  }
}
